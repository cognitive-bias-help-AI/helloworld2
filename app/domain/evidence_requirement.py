...
EVIDENCE_REQUIREMENT_REGISTRY = {
    ...
    EvidenceCategory.BUSINESS_STRATEGY: EvidenceRequirementRule(_DART_NEWS, CoverageLevel.PARTIAL),
    EvidenceCategory.CAPITAL_SHAREHOLDER_ACTION: EvidenceRequirementRule(_DART_NEWS, CoverageLevel.PARTIAL),
    EvidenceCategory.COMPANY_GUIDANCE: EvidenceRequirementRule(_DART_NEWS, CoverageLevel.PARTIAL),
